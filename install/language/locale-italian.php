...
//$wrm_install_lang['headbodyinfo'] = 'Attenzione: il database sul quale verr√† effettuata l\'installazione dev\'essere gi√† esistente.';
...
$wrm_install_lang['configuration_version_outdated_message'] = 'La Installation files in uso di WowRaidManager non Ë l\'ultima disponibile: si consiglia vivamente di aggiornarla.<br>
													   L\'ultima versione Ë %s, mentre quella in uso Ë %s.<br>
...
$wrm_install_lang['step2error01'] = 'Informazioni errate potrebbero causare errori non prevedibili per i quali non verr√† fornita assistenza!';
...
$wrm_install_lang['step5sub3altgroup02'] = 'Agli Utenti appartenenti a questo gruppo sar√† consentito l\'accesso a WRM indipendentemente dall\'appartenenza anche all\'altro gruppo specificato';
