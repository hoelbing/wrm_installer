...
$wrm_install_lang['configuration_version_current'] = 'Du har nyaste versionen av WoW Raid Manager';
$wrm_install_lang['configuration_version_info_header'] = 'Versions Information';
$wrm_install_lang['configuration_version_outdated_header'] = 'WoW Raid Manager uppdatering tillg�nglig!';
$wrm_install_lang['configuration_version_outdated_message'] = 'Din version av WoW Raid Manager �r gammal. Du rekommenderas starkt att uppdatera.<br>
													   Den senaste versionen �r %s och du anv�nder f�r n�rvarande version %s.<br>
													   F�r att ladda ner, bes�k <a href="http://www.wowraidmanager.net">WoW Raid Manager</a>.';
