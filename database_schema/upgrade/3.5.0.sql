-- ALTER TABLE `wrm_chars` ADD `role` VARCHAR(255) NOT NULL default '';
-- ALTER TABLE `wrm_locations` ADD `role1` INT(2) NOT NULL default '0';
-- ALTER TABLE `wrm_locations` ADD `role2` INT(2) NOT NULL default '0';
-- ALTER TABLE `wrm_locations` ADD `role3` INT(2) NOT NULL default '0';
-- ALTER TABLE `wrm_locations` ADD `role4` INT(2) NOT NULL default '0';
-- ALTER TABLE `wrm_locations` ADD `role5` INT(2) NOT NULL default '0';
-- ALTER TABLE `wrm_locations` ADD `role6` INT(2) NOT NULL default '0';
-- ALTER TABLE `wrm_profile` ADD `last_login_time` VARCHAR( 25 ) NOT NULL ;
-- ALTER TABLE `wrm_raids` ADD `role1_lmt` INT(2) NOT NULL default '0';
-- ALTER TABLE `wrm_raids` ADD `role2_lmt` INT(2) NOT NULL default '0';
-- ALTER TABLE `wrm_raids` ADD `role3_lmt` INT(2) NOT NULL default '0';
-- ALTER TABLE `wrm_raids` ADD `role4_lmt` INT(2) NOT NULL default '0';
-- ALTER TABLE `wrm_raids` ADD `role5_lmt` INT(2) NOT NULL default '0';
-- ALTER TABLE `wrm_raids` ADD `role6_lmt` INT(2) NOT NULL default '0';
