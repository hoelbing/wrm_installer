...
$wrm_install_lang['step4unkownauth'] = '(in caso di incertezza, selezionare il sistema di gestione Utenti integrato)';
$wrm_install_lang['step4chooseauth'] = 'Seleziona uno dei tipi di autenticazione.';
